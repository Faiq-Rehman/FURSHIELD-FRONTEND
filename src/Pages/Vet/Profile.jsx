...
import { Stethoscope, Mail, Phone, MapPin, User, Shield } from 'lucide-react';
...
export default function VetProfile() {
  ...
  if (loading) {
    return <div className="py-12 text-center text-slate-500">Loading practice profile...</div>;
  }

  const name = profile?.fullName || profile?.name || 'Dr. Veterinarian';

  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <h1 className="font-display text-4xl font-bold text-slate-900">Veterinary Profile</h1>
        <p className="mt-1 text-sm text-slate-500">Practice profile and professional contact information.</p>
      </div>
        ...
        <div className="flex items-center gap-4 border-b border-slate-100 pb-6">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-emerald-700 capitalize flex items-center gap-1 mt-0.5">
              <Shield size={14} /> Registered Veterinarian Practitioner
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4 text-sm">
          <div className="flex items-center gap-3 bg-slate-50 p-3.5 rounded-2xl">
            ...
            <div>
              ...
              <p className="font-bold text-slate-800">@{profile?.username || 'vet'}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 bg-slate-50 p-3.5 rounded-2xl">
            ...
            <div>
              <p className="text-xs text-slate-400 font-semibold">Clinic / Practice Address</p>
